                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/Foodie/img/pizza-'.$pId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                                <p>Name : <b>' .$pName. '</b></p>
                                                <p>Description : <b class="truncate">' .$pDesc. '</b></p>
                                                <p>Price : <b>' .$pPrice. '</b></p>
                                            </td>
...
<?php 
    $psql = "SELECT * FROM `pizza`";
    $pResult = mysqli_query($conn, $psql);
    while($pRow = mysqli_fetch_assoc($pResult)){
        $pId = $pRow['pId'];
        $pName = $pRow['pName'];
        $pPrice = $pRow['pPrice'];
        $pCategorieId = $pRow['pId'];
        $pDesc = $pRow['pDesc'];
?>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/Foodie/img/pizza-<?php echo $pId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
