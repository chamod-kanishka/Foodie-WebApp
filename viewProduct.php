...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        ?>
        <script> document.getElementById("title").innerHTML = "<?php echo $pName; ?>"; </script> 
        <?php
        echo  '<div class="col-md-4">
                <img src="img/pizza-'.$pId. '.jpg" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                <h3>' . $pName . '</h3>
                <h5 style="color: #ff0000">Rs. '.$pPrice. '/-</h5>
                <p class="mb-0">' .$pDesc .'</p>';
                ...
                <div class="mx-4">
                    <a href="viewProductList.php?catid=' . $pCategorieId . '" class="active text-dark">
